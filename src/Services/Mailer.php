    ...
    public static function sendOrderMail($email):bool {
        ...
        if (isset($email) && !empty($email)) {
            try {
                ...
                $mail->Subject = 'Заявка с сайта: IScream221';
                $mail->Body = "Информационное сообщение c сайта IScream221 <br><br>
                ------------------------------------------<br><br>
                Спасибо!<br><br>
...
$verification_link = Config::SITE_URL . "/verify/" . $verification_token;
                ...
                $mail->Subject = "Подтверждение регистрации с сайта: IScream221";
                $mail->Body = "Информационное сообщение c сайта IScream221 <br><br>
                ------------------------------------------<br><br>
